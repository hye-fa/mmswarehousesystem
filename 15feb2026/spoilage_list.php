...
<head>
    ...
    <title>Spoilage & Supplier Claims</title>
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 px-2">
        <div>
            <h3 class="text-danger fw-bold mb-0">📋 Spoilage & Supplier Claims</h3>
            <small class="text-muted">Unit: Loose Pieces (pcs)</small>
        </div>
        <div class="d-flex gap-2">
            <button onclick="runCleanup()" class="btn btn-outline-secondary btn-sm">
                <i class="bi bi-trash3"></i> Cleanup Photos
            </button>
            <a href="spoilage_report.php" class="btn btn-danger btn-sm">+ New Report</a>
