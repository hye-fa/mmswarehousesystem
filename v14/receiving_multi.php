...
// UPDATED: Strict Formatting (Plate No: No Space, Letters First, Max 4 Num) + Title Case Names
            ...
            <div class="card-body">
                ...
                <div class="row g-3 p-3 bg-light border rounded">
                    ...
                    <div class="col-md-3">
                        ...
                        <!-- UPDATED: Strict Format Plate Logic -->
                ...
                <table class="table table-bordered table-striped table-sm mb-0" id="itemsTable">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th width="15%">Lot / QR Scan</th> <!-- DUAL INPUT -->
...
<script>
    ...
    // Letters First, No Space, Max 4 Digits at end, Optional Letter suffix
    function formatPlate(input) {
        ...
        // 2. Split into parts: Prefix Letters + Numbers + Suffix Letters
        // Regex: Capture (Letters)(Numbers)(Letters)
        let parts = val.split(/(\d+)/);
        
        let final = parts[0] || ""; // Letters
        
        if (parts[1]) {
            // Max 4 digits for numbers
            let nums = parts[1].substring(0, 4);
            final += nums;
            
            if (parts[2]) {
                // Allow suffix letters
