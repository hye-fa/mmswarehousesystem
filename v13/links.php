...
// links.php
// WMS SYSTEM MAP
// UPDATED: Added Import CO and View Batch Reports
...
<div class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-header bg-dark text-white fw-bold" style="background-color: #6610f2 !important;">⚙️ Data Imports & Contracts</div>
                <div class="list-group list-group-flush">
                    <a href="import_co_ui.html" class="list-group-item list-group-item-action d-flex align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold text-primary">Step 1: Import Monthly CO</div>
                            <small class="text-muted">Upload CSV, select districts, & generate SAP Numbers.</small>
                        </div>
                    </a>
                    <a href="view_batch.php" class="list-group-item list-group-item-action d-flex align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold text-primary">Step 2: View Batch Reports</div>
                            <small class="text-muted">View generated SAP list with School Addresses & HDs.</small>
                        </div>
                    </a>
                    <a href="#" class="list-group-item list-group-item-action d-flex align-items-start disabled">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold text-muted">Master School DB</div>
                            <small class="text-muted">Master addresses (Imported). Contact Admin to update.</small>
                        </div>
                    </a>
                </div>
            </div>
