...
// UPDATED: Dual Input Support (Type Manually OR Click Camera Button)
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="category" class="form-select" id="main_category">
                            <option value="PST">PST (Fresh)</option>
...
<script>
    ...
    function addRow(prefillData = null) {
        ...
        const html = `
            <tr id="${rowId}">
                <td>
                    <select name="items[${globalRowCounter}][product_id]" class="form-select form-select-sm prod-select" required onchange="checkRowVolume('${globalRowCounter}')">
                        ${optionsHtml}
                    </select>
                </td>
                <td>
                    <!-- FIXED: Removed readonly/onclick from input. Camera button is separate trigger. -->
                    <div class="input-group input-group-sm">
                        <input type="text" id="scan_input_${globalRowCounter}" 
